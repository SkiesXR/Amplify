...
ep1 = ShowEpisode.create!(title: "'Avengers: Endgame' Breakdown Part 1! Easter Eggs & Details You Missed!", description: "Avengers Endgame, conclusion to the war against Thanos of Avengers Infinity War and finale to the Infinity Saga of the Marvel Cinematic Universe, receives an IN-DEPTH, scene-by-scene analysis by Erik Voss and Filup Molina, teaming up to tackle the biggest film event of our lifetimes. Where are all the secret references to MCU history and Marvel comics in Endgame? How does Endgame's version of time travel work, exactly? What carefully hidden visual clues throughout the film hint at the fates of Tony Stark, Captain America, Black Widow, Thanos, and the rest? How does the Avengers Endgame timeline FIX many loose ends of the broader MCU timeline, but also, how does Avengers Endgame REWRITE that history? (PART 1 of a 2-part breakdown series of Avengers Endgame!)", release_date: "2019-05-02", show_id: s1.id, length: "39:09", episode_audio: "https://chtbl.com/track/E2288/traffic.megaphone.fm/STA5688959148.mp3")
ep2 = ShowEpisode.create!(title: "Episode 12: Minority Report", description: "The LFTS team discusses Steven Spielberg's take on film noir (is it actually a film noir?), explore the ways in which the film is such a great example of design fiction, and debate the morality of Precrime.", release_date: "2019-06-14", show_id: s2.id, length: "01:00:02", episode_audio: "https://anchor.fm/s/86e1204/podcast/play/3562058/sponsor/acee3f,afksi4/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2019-5-14%2FEpisode-12--Minority-Report-da9cd896322ee.m4a")
ep3 = ShowEpisode.create!(title: "Craig Ferguson #3", description: "Craig Ferguson returns to the podcast for a third time! They talk about what Scotland is like, where they like to do standup and how Craig likes living a quieter life now. Craig also talks about when he decided to leave late night, what he learned from working so hard over the years and his new memoir Riding the Elephant, out May 7th!", release_date: "2019-05-01", show_id: s3.id, length: "01:11:57", episode_audio: "https://rss.art19.com/episodes/ceb38a74-9264-449d-a5ee-e7c074798d7c.mp3")
ep4 = ShowEpisode.create!(title: "Ep. 76: How to become a successful freelancer", description: "In this week's episode of the freeCodeCamp podcast, Abbey chats with software developer and freelancer Kyle Prinsloo who lives and works in South Africa. Kyle knew from a young age that he wanted to pursue a career in business. He launched websites with his brother, worked various jobs, and eventually gained...", release_date: "2019-08-12", show_id: s4.id, length: "01:24:28", episode_audio: "https://traffic.libsyn.com/secure/forcedn/freecodecamp/Abbey_and_Kyle_podcast_final.mp3")
ep5 = ShowEpisode.create!(title: "The economy still isn't working for people of color", description: "This week, we dive into the latest research on racial inequality.", release_date: "2019-08-06", show_id: s5.id, length: "35:43", episode_audio: "https://download.publicradio.org/podcast/marketplace/make_me_smart/2019/08/06/mms_20190806_128.mp3")
ep6 = ShowEpisode.create!(title: "James Corden", description: "The Late Late Show host talks about Gavin and Stacy, The History Boys and how (at first) no-one wanted to be on Carpool Karaoke.", release_date: "2019-04-01", show_id: s6.id, length: "52:25", episode_audio: "https://media.acast.com/davidtennant/jamescorden/media.mp3")
ep7 = ShowEpisode.create!(title: "G: Relative Genius", description: "Albert Einstein asked that when he died, his body be cremated and his ashes be scattered in a secret location. He didn’t want his grave, or his body, becoming a shrine to his genius. When he passed away in the early morning hours of April, 18, 1955, his family knew his wishes. There was only one problem: the pathologist who did the autopsy had different plans. In the third episode of 'G', Radiolab’s miniseries on intelligence, we go on one of the strangest scavenger hunts for genius the world has ever seen. We follow Einstein’s stolen brain from that Princeton autopsy table, to a cider box in Wichita, Kansas, to labs all across the country. And eventually, beyond the brain itself entirely. All the while wondering, where exactly is the genius of a man who changed the way we view the world?", release_date: "2019-06-28", show_id: s7.id, length: "01:02:55", episode_audio: "https://www.podtrac.com/pts/redirect.mp3/audio.wnyc.org/radiolab_podcast/radiolab_podcast19relativegenius_intelligence-series.mp3")
ep8 = ShowEpisode.create!(title: "Inside Hong Kong's Airport", description: "Protesters have flooded Hong Kong’s airport, paralyzing operations and escalating tensions between the semiautonomous territory and Beijing. The protesters are trying to send a message to government officials — and to people in mainland China.", release_date: "2019-08-14", show_id: s8.id, length: "23:41", episode_audio: "https://rss.art19.com/episodes/e6a4439b-c55c-429a-ad3f-bbc005b6bea0.mp3")
ep9 = ShowEpisode.create!(title: "I Buy, Therefore I Am: How Brands Become Part Of Who We Are", description: "All of us are surrounded by brands. Designer brands. Bargain-shopper brands. Brands for seemingly every demographic slice among us. But have you ever stopped to ask yourself how brands influence you? This week, we look at how companies create a worldview around the products they sell, and then get us to make those products a part of who we are.", release_date: "2019-07-01", show_id: s9.id, length: "33:29", episode_audio: "https://play.podtrac.com/npr-510308/edge1.pod.npr.org/anon.npr-podcasts/podcast/npr/hiddenbrain/2019/07/20190701_hiddenbrain_hb_i_buy_therefore_i_am_pod_mix_07-01_405_pm-304ef654-ea58-4807-a4fb-f81b219988f1.mp3")
