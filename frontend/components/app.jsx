...
const App = () => (
    <div>
        <Switch>
            ...
            <ProtectedRoute exact path="/browse/podcasts" component={ AmplifyPlayer } />
            <ProtectedRoute exact path="/browse/genres" component={ AmplifyPlayer } />
            <ProtectedRoute exact path="/browse/discover" component={ AmplifyPlayer } />
