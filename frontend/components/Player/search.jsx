                ...
                <div className="results">
                    {podcasts.map(podcast => {
                        return (
                            <div className="album-artist-container">
                                <div className="image-hover-container">
                                    <Link to={`/shows/${podcast.id}`}><img src={podcast.show_photo} />
                                        <div className="Mike">
                                            <button id="Mike-button">
                                                <img id="Mike" src="play_white.png" />
                                            </button>
                                ...
                                <div className="artist-container">
                                    <Link id="grid-artist" to={`/shows/${podcast.id}`}>{podcast.title}</Link>
                                </div>
                            </div>
                        );
                    })}
        ...
        return(
            <div className="search-container">
                ...
                <div className="search-results-main">
                    ...
                    { podcastResults.length > 0 ? this.displayPodcasts(podcastResults) : ""}
                </div>
            </div>
        );
    }
